...
void tag_obj_in_region1(int xmin, int ymin, int xmax, int ymax); static void sel_line(int xmin, int ymin, int xmax, int ymax); static void get_line(F_line** list); 
static void get_arc(F_arc** list); 
static void sel_arc(int xmin, int ymin, int xmax, int ymax); static void get_compound(F_compound** list); 
static void sel_compound(int xmin, int ymin, int xmax, int ymax); static void get_ellipse(F_ellipse** list); 
static void sel_ellipse(int xmin, int ymin, int xmax, int ymax); static void sel_line(int xmin, int ymin, int xmax, int ymax); static void get_spline(F_spline** list); 
static void sel_spline(int xmin, int ymin, int xmax, int ymax); static void get_text(F_text** list); 
